...
def main():
    ...
    # README
    print(f"\nCreating README...")
    readme = "# day3_14 - Zeno Wholebody ACT Models\n\n"
    readme += "Stage1 (hanger) + Stage2 (move) ACT policies for Zeno wholebody robot.\n\n"
    readme += "## Changes from day3_13\n\n"
    readme += "- `n_action_steps`: 100 -> 1 (for temporal ensembling)\n"
    readme += "- `batch_size`: 32 -> 64\n"
    readme += "- `steps`: 100000 -> 200000\n"
    readme += "- wandb tracking enabled\n\n"
    readme += "## Models\n\n"
    readme += "| Model | Task | Checkpoints |\n"
    readme += "|-------|------|-------------|\n"
    readme += "| stage1_act | hanger | 100000, 150000, 200000 |\n"
    readme += "| stage2_act | move   | 100000, 150000, 200000 |\n\n"
    readme += "## Input/Output\n\n"
    ...
    readme += "## Download\n\n"
    readme += "```bash\n"
    readme += f"huggingface-cli download {REPO_ID} --repo-type model --local-dir ./day3_14\n"
    readme += "```\n"
