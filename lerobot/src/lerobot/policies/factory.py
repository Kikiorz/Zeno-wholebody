...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        from lerobot.policies.act_x.modeling_act_x import ACTXPolicy
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "moe_act":
        return MoEACTConfig(**kwargs)
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, ACTXConfig):
        from lerobot.policies.act_x.processor_act_x import make_act_x_pre_post_processors

        processors = make_act_x_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )

    elif isinstance(policy_cfg, MoEACTConfig):
        from lerobot.policies.moe_act.processor_moe_act import make_moe_act_pre_post_processors

        processors = make_moe_act_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
